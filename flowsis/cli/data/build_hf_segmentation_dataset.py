    ...
    *,
            ...
            rows.append(
                {
                    ...
                    "target_area": float(bbox[2] * bbox[3]),
                    "target_mask_path": normalize_path(mask_path),
    ...
    features = Features(
        {
            ...
            "modified": Value("bool"),
            "target_category": ClassLabel(names=category_names),
            "target_label": Value("string"),
            "target_bbox": Sequence(Value("float32"), length=4),
            "target_area": Value("float32"),
            "target_mask_path": Value("string"),
            "text_embedding_path": Value("string"),
            "cache_key": Value("string"),
            "cache_dir": Value("string"),
            "offline_augmented": Value("bool"),
            "augmentation_id": Value("string"),
            "objects": [
                {
                    "id": Value("int64"),
                    "area": Value("float32"),
    ...
    print(
        "build_dataset",
        {
            ...
            "notes": [
                "For online training, read image_path + target_mask_path + text_embedding_path.",
